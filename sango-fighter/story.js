// ============================================================
// story.js — Story mode data for Sango Fighter
// ============================================================
...
const STORY_CAMPAIGNS = {
  ...
  '蜀漢': {
    ...
    protagonist: 'zhaoyun', // default protagonist
    ...
    chapters: [
      {
        ...
        battles: [
          { opponent: 'sword_soldier', opponentType: 'soldier', dialogBefore: [{ speaker: '趙雲', text: '區區小兵，看我槍法！' }] },
          { opponent: 'spear_soldier', opponentType: 'soldier', dialogBefore: [{ speaker: '趙雲', text: '再來！' }] },
      ...
      },
      {
        ...
        battles: [
          ...
          {
            opponent: 'lvbu', opponentType: 'character',
            dialogBefore: [
              { speaker: '呂布', text: '何人敢擋我去路？' },
              { speaker: '張飛', text: '燕人張飛在此！' }
            ],
            dialogAfter: [
              { speaker: '旁白', text: '呂布敗退，諸侯軍士氣大振！' }
            ]
          }
        ],
        dialogsAfter: [
          { speaker: '旁白', text: '虎牢關一戰，劉關張三兄弟名震天下。' }
        ]
      },
      {
        id: 'shu_ch3',
        ...
        battles: [
          ...
          { opponent: 'spear_soldier', opponentType: 'soldier' },
          {
            opponent: 'xiahouyuan', opponentType: 'character',
            dialogBefore: [
          ...
          {
            opponent: 'xuchu', opponentType: 'character',
            dialogBefore: [
      ...
      },
      {
        ...
        battles: [
          ...
          { opponent: 'spear_soldier', opponentType: 'soldier' },
          {
            opponent: 'caocao', opponentType: 'character',
            dialogBefore: [
              { speaker: '曹操', text: '雲長...念在昔日之情...' },
              { speaker: '關羽', text: '丞相...今日華容道，我義釋你！但下不為例！' }
            ],
            dialogAfter: [
              { speaker: '旁白', text: '關羽義釋曹操，赤壁之戰以孫劉聯軍大勝告終。' }
            ]
          }
        ],
        dialogsAfter: [
          { speaker: '旁白', text: '赤壁大捷！曹操北歸，三分天下之勢已成。' }
        ]
      },
      {
        id: 'shu_ch5',
        ...
        battles: [
          ...
          {
            opponent: 'xuhuang', opponentType: 'character',
            dialogBefore: [
          ...
          },
          {
            ...
            dialogAfter: [
              { speaker: '旁白', text: '黃忠斬夏侯淵於定軍山下，漢中之戰大勝！' }
            ]
          }
        ],
        dialogsAfter: [
          { speaker: '旁白', text: '劉備奪取漢中，自稱漢中王，蜀漢基業已定！' }
        ]
      }
    ]
  },
    ...
    chapters: [
      {
        ...
        battles: [
          ...
          { opponent: 'blade_soldier', opponentType: 'soldier' },
          {
            opponent: 'dongzhuo', opponentType: 'character',
            dialogBefore: [
              { speaker: '董卓', text: '大膽！竟敢行刺本太師！' },
              { speaker: '曹操', text: '為天下蒼生，今日必除你！' }
            ],
            dialogAfter: [
              { speaker: '旁白', text: '曹操刺殺未成，但已展露了他的雄心壯志。' }
            ]
          }
        ],
        dialogsAfter: [
          { speaker: '旁白', text: '曹操逃離洛陽，開始了他統一北方的征途。' }
        ]
      },
      {
        id: 'wei_ch2',
      ...
      },
      {
        ...
        battles: [
          ...
          { opponent: 'blade_soldier', opponentType: 'soldier' },
          {
            opponent: 'yuanshao', opponentType: 'character',
            dialogBefore: [
              { speaker: '袁紹', text: '曹阿瞞！你怎敢以弱抗強！' },
              { speaker: '曹操', text: '本初兄，勝敗不在兵多寡，在用兵之人！' }
            ],
            dialogAfter: [
              { speaker: '曹操', text: '袁紹已敗，北方即將統一！' }
            ]
          }
        ],
        dialogsAfter: [
          { speaker: '旁白', text: '官渡大捷！曹操以寡擊眾，奠定了統一北方的基礎。' }
        ]
      },
      {
        id: 'wei_ch4',
      ...
      },
      {
        ...
        battles: [
          ...
          { opponent: 'spear_soldier', opponentType: 'soldier' },
          {
            opponent: 'huanggai', opponentType: 'character',
            dialogBefore: [
          ...
          {
            opponent: 'zhouyu', opponentType: 'character',
            dialogBefore: [
              { speaker: '周瑜', text: '曹賊！赤壁將成你的葬身之地！' },
              { speaker: '曹操', text: '周瑜小兒，看我天下之威！' }
            ],
            dialogAfter: [
              { speaker: '旁白', text: '赤壁大火起，曹軍損失慘重...' }
            ]
          }
        ],
        dialogsAfter: [
          { speaker: '旁白', text: '赤壁之敗讓曹操損失慘重，但北方根基穩固。三分天下的格局就此形成。' },
    ...
    chapters: [
      ...
      },
      {
        ...
        battles: [
          ...
          { opponent: 'spear_soldier', opponentType: 'soldier' },
          {
            opponent: 'taishici', opponentType: 'character',
            dialogBefore: [
        ...
        dialogsAfter: [
          { speaker: '旁白', text: '孫策收服太史慈，江東勢力日漸壯大。' }
        ]
      },
      {
        id: 'wu_ch3',
      ...
      },
      {
        ...
        battles: [
          ...
          },
          {
            ...
            dialogAfter: [
              { speaker: '旁白', text: '赤壁大火燒盡曹軍連環戰船，大勝！' }
            ]
          }
        ],
        dialogsAfter: [
      ...
      },
      {
        ...
        battles: [
          ...
          { opponent: 'sword_soldier', opponentType: 'soldier' },
          {
            opponent: 'zhangfei', opponentType: 'character',
            dialogBefore: [
          ...
          {
            opponent: 'zhaoyun', opponentType: 'character',
            dialogBefore: [
        ...
        dialogsAfter: [
          { speaker: '旁白', text: '夷陵之戰以東吳大勝告終，蜀漢元氣大傷。三國鼎立的格局更加穩固。' }
        ]
      }
    ]
  }
